...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _user_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./user.js */ \"./src/user.js\");\n\r\n\r\nasync function showComments() {\r\n  try {\r\n    const user = await _user_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"].getUser(123);\r\n    const courses = await _user_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"].getCourses(user.name);\r\n    const comment = await _user_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"].getComments(courses[0]);\r\n    console.log(comment);\r\n  } catch (error) {\r\n    console.log(error);\r\n  }\r\n}\r\n\r\nshowComments()\n\n//# sourceURL=webpack://webpack/./src/index.js?");
